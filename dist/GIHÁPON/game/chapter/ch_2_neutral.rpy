...
#EXT. JOBERT’S HOUSE - JUNE 16, 1992. 4:30 P.M.
    ...
    menu:
        ...
        "Talk Calmly":
            ...
            MC "Then who are you with all this time beside Berto?"

            show jobert - surprised
            side_jobert "I- 
            {w=0.5}Uhm{cps=*0.5}...{/cps}" with sshake
            window hide
            show dy - angry at left
            show azzi - confused at right
            show jobert at offscreenright
            ...
            window show
            d "Tell us Jobert, 
            {w=0.5}we're trying to help you here."
        ...
        "Talk Aggressively":
            ...
            MC "Just answer the question! Jobert, 
            ...
            d "Hey! 
            {w=0.5}Jobert, 
            {w=0.5}that's enough!" with sshake
...
###---------------------------------------------------------###
    ...
    window show
    d "We talked to Berto before we got here. 
    {w=0.5}He told us what happened and why you keep drinking since then. 
    {w=0.5}He also mentioned that you have been drinking with someone else before you went to him."
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    show jobert - surprised at center
    ...
    with decay10inleft
    window show
    d "If you keep covering for your friend, 
    {w=0.5}you’ll be involved in this case even though you didn’t do anything."
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    show jobert - sad at center
...
#EXT. MAYA’S HOUSE - JUNE 16, 1992. 5:30 P.M.
    ...
    side_lola "No- 
    {w=0.5}What are you going to do with my Apo?"
    window hide
    show dy at left
    show azzi at right
    show lola at offscreenright
    ...
    azzi "Nothing, 
    {w=0.5}Lola. 
    {w=0.5}We’re just going to talk to her. 
    {w=0.5}Don’t worry."
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    ...
    window show 
    MC "{=txt_vo}(Now that Lola is inside, 
    {w=0.5}maybe we can make Maya confess)"
    window hide
    show dy at left
    show azzi at right
    show maya at offscreenright
    with decay10inleft
    window show
    d "Were you at the Montero’s yesterday?" 
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    ...
    play sound SFX_Smack
    d "Really? 
    {w=0.5}Then why did Jobert mention your name?" with sshake
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    show maya - angry at center
    ...
    play sound SFX_Smack
    side_maya "Jobert? 
    {w=0.5}I don’t know what you’re talking about!" with sshake
    window hide
    show dy - neutral at left
    show azzi at right
    show maya at offscreenright
    ...
    window show
    d "Then, 
    {w=0.5}I guess we have no choice but to take you to the police station-"
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    show maya - scared at center
    ...
    side_maya "I-{w=0.5}{nw}" 
    play sound SFX_Smack
    extend " I didn’t do it on purpose." with sshake
    
    MC "Just tell us the truth,{w=0.5}{nw}"
    play sound SFX_Smack
    extend " Maya!"
    ...
    window show
    side_maya "No. 
    {w=0.5}They’re people who are above the law. 
    {w=0.5}A mere detective can’t win against them."
    window hide
    show dy - angry at left
    show azzi at right
    show maya at offscreenright
    ...
    d "Trust me, 
    {w=0.5}Maya. 
    {w=0.5}I promise to make them pay."
    window hide
    show dy at offscreenleft
    show azzi at offscreenleft
    show maya at center
    ...
    MC "Something went missing from my belongings since that incident."
    show maya - neutral
    with dissolve
    side_maya "The letter?"
    window hide
    show dy - neutral at left
    show azzi at right
    show maya at offscreenright
    ...
    with decay10inleft
    window show
    side_maya "I sent it to them already."
    window hide
    show dy at left
    show azzi at right
    show maya at offscreenright
    ...
    side_maya "I’m sorry, 
    {w=0.5}Detective. 
    {w=0.5}I can’t tell you."

    MC "{=txt_vo}(Why do they need the letter? 
    {w=0.5}Who the heck are they??)"
    window hide
    show dy at left
    show azzi at right
    show maya at offscreenright
